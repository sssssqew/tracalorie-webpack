...
class CalorieTracker{
    ...
    _displayNewMeal(meal){
        ...
        mealEl.setAttribute('data-id', meal.id) // check for what kind of item when deleting
        mealEl.innerHTML = `
            <div class="card-body">
    ...
    _displayNewWorkout(workout){
        ...
        workoutEl.setAttribute('data-id', workout.id) // check for what kind of item when deleting
        workoutEl.innerHTML = `
            <div class="card-body">
                <div class="d-flex align-items-center justify-content-between">
